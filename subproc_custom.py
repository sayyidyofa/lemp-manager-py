# subprocess - Subprocesses with accessible I/O streams, modified. method communicate only return stdout
#
...
The method communicate() is modified and only returns stdout!!
